...
api.nvim_set_keymap("n", "<Esc><Esc>", "<Cmd>bdelete<CR>", {noremap = true, silent = true})
...
api.nvim_set_keymap("", "os", "<Cmd>e ++enc=cp932<CR>", {noremap = true, silent = true})
api.nvim_set_keymap("", "oe", "<Cmd>e ++enc=euc-jp<CR>", {noremap = true, silent = true})
api.nvim_set_keymap("", "ou", "<Cmd>e ++enc=utf-8<CR>", {noremap = true, silent = true})
...
api.nvim_set_keymap("n", "<Leader>q", "<Cmd>bd<CR>", {noremap = true, silent = true})
api.nvim_set_keymap("n", "<Leader>w", "<Cmd>w<CR><Cmd>bd<CR>", {noremap = true, silent = true})
api.nvim_set_keymap("n", "<Leader>n", "<Cmd>enew<CR>", {noremap = true, silent = true})
...
api.nvim_set_keymap("i", "<Esc>", "<Esc><Cmd>set iminsert=0<CR>", {noremap = true, silent = true})
api.nvim_set_keymap("i", "jj", "<Esc><Cmd>set iminsert=0<CR>", {noremap = true, silent = true})
