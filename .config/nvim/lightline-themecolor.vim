...
let s:p.normal.right    = [[s:white, s:gray3]    , [s:white, s:gray4]]
...
let s:p.insert.right    = [[s:white, s:gray3]   , [s:white, s:gray4]]
let s:p.replace.left    = [[s:black, s:yellow]  , [s:white, s:gray3]]
let s:p.replace.right   = [[s:white, s:gray3]  , [s:white, s:gray4]]
