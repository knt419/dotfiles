...
let s:gray2_gui    = "#989088"
let s:gray3_gui    = "#767056"
let s:gray4_gui    = "#48403a"
...
let s:p.normal.right    = [[s:black, s:gray3]    , [s:white, s:gray4]]
let s:p.inactive.left   = [[s:white, s:gray2]   , [s:white, s:gray3]]
let s:p.inactive.middle = [[s:black, s:gray4]]
let s:p.inactive.right  = [[s:white, s:gray2]   , [s:white, s:gray4]]
let s:p.insert.left     = [[s:black, s:green]   , [s:green, s:gray3]]
let s:p.insert.right    = [[s:black, s:gray3]   , [s:white, s:gray4]]
let s:p.replace.left    = [[s:black, s:yellow]  , [s:yellow, s:gray3]]
let s:p.replace.right   = [[s:black, s:gray3]  , [s:white, s:gray4]]
let s:p.visual.left     = [[s:white, s:magenta] , [s:magenta, s:gray3]]
let s:p.visual.right    = [[s:white, s:gray3] , [s:white, s:gray4]]
